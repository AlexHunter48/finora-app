...
export default function Hero() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-[#121212] via-[#121212]/50 to-transparent lg:hidden"></div>

      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-64px)] w-full max-w-7xl flex-col justify-start px-6 pt-13 pb-8 lg:justify-start lg:px-0 lg:pt-30 lg:pb-0">
        <div className="max-w-xl lg:px-6 xl:px-5">
          ...
          <p className="text-md mb-6 leading-relaxed text-gray-300 md:text-lg">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <button className="w-fit rounded-full border border-gray-500 bg-transparent px-4 py-3 text-base font-bold text-white transition-all duration-200 hover:bg-white/10 md:block lg:px-8 lg:py-4 lg:text-lg">
              See how it works
            </button>
          </div>
        </div>
