    ...
    <section className="min-h-screen bg-[#0F0E0D]">
      <div className="grid min-h-screen lg:grid-cols-2">
        <div className="flex items-center justify-center px-6 py-10 lg:px-16">
          <div className="w-full max-w-[480px] rounded-[30px] border border-white/[0.06] bg-[#171513]/90 px-10 py-10 text-gray-300 shadow-[0_40px_120px_rgba(0,0,0,0.65)] backdrop-blur-2xl lg:px-10 lg:py-10">
